...
public class ProprietaireDTO implements Serializable{
    ...
    {
        if(ProprietaireDTO.isNumeric(cin))
        {
            this.cin=cin;
        }
        else{
    ...
    public ProprietaireDTO(String cin, String nom, String prenom, String sexe, Date dateNaissance, String contact, String adresse) throws Exception{
        this.setcin(cin);
        this.setnom(nom);
      ...
      public ProprietaireDTO( String cin,String nom, String prenom, String sexe, String dateNaissance, String contact, String adresse) throws Exception{
        this.setcin(cin);
        this.setnom(nom);
        this.setprenom(prenom);
        this.setsexe(sexe);
