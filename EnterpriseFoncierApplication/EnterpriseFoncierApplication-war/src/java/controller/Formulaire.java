...
import sessionBean.DeviseRemote;
...
public class Formulaire extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           DeviseRemote ta=(DeviseRemote)ps.lookup("java:global/EntrepriseBanqueApplication/EjbBanque/Devise!sessionBean.DeviseRemote");
           ArrayList<DeviseDTO> devise=ta.getAll(null, null);
